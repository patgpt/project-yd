import { defineComponent as defineComponent$1, hasInjectionContext, inject as inject$1, getCurrentInstance as getCurrentInstance$1, computed, toValue, Fragment, capitalize, warn, toRef, ref, h, Suspense, provide, reactive, watchEffect, watch, onScopeDispose, unref, shallowRef, toRaw, createVNode, mergeProps, createElementVNode, shallowReactive, effectScope, normalizeClass, defineAsyncComponent, createElementBlock, createApp, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, isReadonly, isRef, isShallow, isReactive, getCurrentScope, withCtx, toRefs, nextTick, useSSRContext } from 'vue';
import { w as withQuery, j as hasProtocol, k as isScriptProtocol, l as joinURL, m as klona, n as defuFn, e as createError$1, o as getContext, s as sanitizeStatusCode, $ as $fetch$1, q as baseURL, r as createHooks, t as executeAsync, v as toRouteMatcher, x as createRouter$1, y as defu } from '../nitro/nitro.mjs';
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-BzQE7who.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-CJ-L6nRj.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-Du9XC7AU.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-CreHKfXn.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-DlB8j1Yo.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-D8yhG24c.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-DgMv4kxk.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-BkYhIIIi.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-C58Q6dGT.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-B5xLOlf-.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-C68vDTlu.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-DcR3lwK2.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-WxRDpCyr.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-SBLK7qrj.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-CKz3SZcp.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-nxcWxD_v.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-CBIUP7LQ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-CYDmE5IF.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-DJqzcrBp.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-4SWy9O1V.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-CslWQKIL.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-C-NytczG.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-0ELChhUD.mjs').then((r) => r["default"] || r.default || r));
const LazyIcon = defineAsyncComponent(() => import('./index-BZMdSWtq.mjs').then((r) => r["default"] || r.default || r));
...
function vuetifyConfiguration() {
  const options = { "blueprint": { "defaults": { "VAppBar": { "flat": true }, "VAutocomplete": { "variant": "outlined" }, "VBanner": { "color": "primary" }, "VBottomSheet": { "contentClass": "rounded-t-xl overflow-hidden" }, "VBtn": { "color": "primary", "rounded": "xl" }, "VBtnGroup": { "rounded": "xl", "VBtn": { "rounded": null } }, "VCard": { "rounded": "lg" }, "VCheckbox": { "color": "secondary", "inset": true }, "VChip": { "rounded": "sm" }, "VCombobox": { "variant": "outlined" }, "VDateInput": { "variant": "outlined" }, "VDatePicker": { "controlHeight": 48, "color": "primary", "divided": true, "headerColor": "", "elevation": 3, "rounded": "xl", "VBtn": { "color": "high-emphasis", "rounded": "circle" } }, "VFileInput": { "variant": "outlined" }, "VNavigationDrawer": {}, "VNumberInput": { "variant": "outlined", "VBtn": {} }, "VSelect": { "variant": "outlined" }, "VSlider": { "color": "primary" }, "VTabs": { "color": "primary" }, "VTextarea": { "variant": "outlined" }, "VTextField": { "variant": "outlined" }, "VToolbar": { "VBtn": { "color": null } } }, "theme": { "themes": { "light": { "colors": { "primary": "#6750a4", "secondary": "#b4b0bb", "tertiary": "#7d5260", "error": "#b3261e", "surface": "#fffbfe" } } } } }, "theme": { "cspNonce": "1337-yd", "defaultTheme": "light", "themes": { "light": { "dark": false, "colors": { "primary": "#b388ff", "secondary": "#fff59d", "accent": "#ffc107" } }, "dark": { "colors": { "primary": "#b388ff", "secondary": "#fff59d", "accent": "#ffc107" } } } }, "ssr": true };
  return options;
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Dc7JcDnc.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BxK3xEbo.mjs'));
