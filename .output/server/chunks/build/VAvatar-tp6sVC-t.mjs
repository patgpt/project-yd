import { u as useDimension, a as useRender, m as makeTagProps, b as makeDimensionProps, c as makeComponentProps } from './VContainer-D--PGBTh.mjs';
import { g as genericComponent, a as propsFactory, b as provideTheme, w as getCurrentInstanceName, k as getCurrentInstance, W as hasEvent, f as deepEqual, m as makeThemeProps, I as IconValue, o as useRtl, e as destructComputed, M as includes, i as convertToUnit, t as templateRef, O as isCssColor, P as isParsableColor, Q as parseColor, R as getForeground, N as breakpoints, p as provideDefaults, u as useProxiedModel, j as clamp, X as isObject, T as useTheme, U as useIcon, V as flattenFragments, Y as onlyDefinedProps, x as wrapInArray, d as consoleWarn, S as findChildrenWithProvide } from './server.mjs';
import { computed, toRef, h, isRef, resolveDynamicComponent, reactive, toValue, useId, provide, inject, watch, nextTick, ref, readonly, capitalize, createElementVNode, Fragment, normalizeClass, shallowRef, withDirectives, createVNode, mergeProps, toRefs, normalizeStyle, Transition, vShow, Text, TransitionGroup, watchEffect, toDisplayString, unref } from 'vue';
...
export { useBackgroundColor as A, useTextColor as B, useRouter as C, makeTransitionProps as D, parseAnchor as E, flipSide as F, flipAlign as G, flipCorner as H, Intersect as I, getAxis as J, useResizeObserver as K, LoaderSlot as L, MaybeTransition as M, toPhysical as N, makeVBtnProps as O, useIntersectionObserver as P, Ripple as R, VRow as V, VCol as a, VBtn as b, useVariant as c, useDensity as d, useElevation as e, useLoader as f, useLocation as g, usePosition as h, useRounded as i, useLink as j, genOverlays as k, VImg as l, VDefaultsProvider as m, VProgressLinear as n, makeVariantProps as o, makeRouterProps as p, makeRoundedProps as q, makePositionProps as r, makeLocationProps as s, makeLoaderProps as t, useBorder as u, makeElevationProps as v, makeDensityProps as w, makeBorderProps as x, VAvatar as y, VIcon as z };
//# sourceMappingURL=VAvatar-tp6sVC-t.mjs.map
